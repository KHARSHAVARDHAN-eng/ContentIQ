...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-[#fafafa] relative overflow-hidden font-sans select-none">
      ...
      {/* Background soft decoration lines matching elite dashboard */}
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-3 mb-6">
          ...
          <div className="text-center space-y-1">
            <h1 className="text-lg font-bold text-[#18181b] tracking-tight">
              DocumentIQ Workspace
            </h1>
            <p className="text-zinc-500 text-xs font-semibold">Sign in to authorize your session</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full mt-2 py-2.5 bg-[#18181b] hover:bg-zinc-800 disabled:bg-zinc-100 disabled:text-zinc-400 text-white font-bold rounded-full shadow-sm transition-all duration-200 flex items-center justify-center space-x-2 cursor-pointer text-xs uppercase tracking-wider btn-press-active"
          >
            {isSubmitting ? (
        ...
        <p className="mt-5 text-center text-xs text-zinc-500 font-semibold">
          New to DocumentIQ?{' '}
          <Link to="/register" className="font-bold text-[#18181b] hover:underline uppercase tracking-wider pl-1">
            Register
          </Link>
        </p>
      </motion.div>
